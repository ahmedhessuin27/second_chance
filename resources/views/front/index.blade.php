                ...
                @foreach ($category as $cat )
                    ...
                    <div class="collection-banner p-bottom p-center text-center">
                        <a href="shop-left-sidebar.html" class="banner-img">
                            <img src="{{asset('uploads/category/'.$cat->category_image)}}" class="blur-up lazyload" alt="">
                        </a>
                        ...
                        <div class="product-box">
                            <div class="img-wrapper">
                                ...
                                <div class="label-block">
                                    <span class="label label-theme">{{ $product->{'name_'. LaravelLocalization::getCurrentLocale()} }}</span>
                                </div>
                                <div class="cart-wrap">
                                    <ul>
                            ...
                            <div class="product-style-3 product-style-chair">
                                <div class="product-title d-block mb-0">
                                    ...
                                    <p class="font-light mb-sm-2 mb-0">{{ $product->{'description_'. LaravelLocalization::getCurrentLocale()} }}</p>
